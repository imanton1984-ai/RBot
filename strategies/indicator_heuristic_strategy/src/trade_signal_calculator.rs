// strategies/indicator_heuristic_strategy/src/trade_signal_calculator.rs
...
use crate::scorer::{IndicatorHeuristicScorer, IndicatorHeuristicScoreBreakdown, SetupKind};
...
impl TradeSignalCalculator {
    ...
    fn calculate_tp_sl(
        ...
        let heuristic_tp1 = if let Some(target) = heuristic_price_target {
        ...
        let tp1 = if side > 0 {
            heuristic_tp1.max(min_tp1)
        } else {
            heuristic_tp1.min(min_tp1)
        };
    ...
    pub async fn build_trade_signal(
        &self,
        pool: &PgPool,
        scorer: &IndicatorHeuristicScorer,
        time: DateTime<Utc>,
        time_ms: i64,
        symbol_id: i64,
        symbol: &Symbol,
        ...
        let breakdown_opt: Option<IndicatorHeuristicScoreBreakdown> = scorer
        ...
        let breakdown_json = json!({
            ...
            "heuristic_prediction_score": breakdown.heuristic_prediction_score,
            ...
            "strategy_id": 2,
            "strategy_name": "indicator_heuristic",
        });
